...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-bil-data-viewer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15337&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-bil-data-viewer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-bil-data-viewer` can be installed with:

```
conda install napari-bil-data-viewer
```

It is possible to list all of the versions of `napari-bil-data-viewer` available on your platform with:
